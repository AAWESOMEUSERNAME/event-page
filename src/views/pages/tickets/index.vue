...
const currentTicket = ref<TICKET>(TICKET.full_lindy)
const onChange = (k: TICKET) => {
    currentTicket.value = k
}
    ...
    <Content :custom-cls="{ container: $style.container, inner: $style.inner }">
        ...
        <div :class="$style.classes__container">
            <div :class="$style.cards">
                <TicketCards :current="currentTicket" :on-change="onChange" />
            </div>
            <div :class="$style.classes__detail">

            </div>
            <div :class="$style.classes">
                <div :class="$style.classes__card" v-if="currentTicket === TICKET.full_lindy">
                ...
                <div :class="$style.classes__card" v-if="currentTicket === TICKET.full_lindy_performance">
                ...
                <div :class="$style.classes__card" v-if="currentTicket === TICKET.full_solo">
                ...
                <div :class="$style.classes__card" v-if="currentTicket === TICKET.full_solo_performance">
